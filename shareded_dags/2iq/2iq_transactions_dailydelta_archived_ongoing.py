...
WORKFLOW_FILE = os.path.join(WORKFLOW_DIRECTORY, 
                		'2iq', '2iq_transactions_dailydelta_archived_ongoing.yaml')

AIRFLOW_CONF_DICT = {
    "dag": {
        "max_active_runs": 1,
        "owner": "CruxInformatics",
        "schedule_interval": '20 7,12,16 * * *',
        "priority_weight": 1,
        "dag_start_date": '2020-08-25',
        "dag_catchup": True

    },
    "crux_api_conf": "${2IQ_TRANSACTIONS_DAILYDELTA_ARCHIVED_ONGOING_API}",
    "endpoint": "${API_HOST}" 
}
