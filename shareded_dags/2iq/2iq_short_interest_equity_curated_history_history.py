...
WORKFLOW_FILE = os.path.join(WORKFLOW_DIRECTORY, 
                		'2iq', '2iq_short_interest_equity_curated_history_history.yaml')
...
AIRFLOW_CONF_DICT = {
    "dag": {
        ...
        "priority_weight": 1,
        "dag_start_date": '2009-12-31',
        "dag_end_date": '2019-12-31',
        "dag_catchup": True

    },
    "crux_api_conf": "${2IQ_SHORT_INTEREST_EQUITY_CURATED_HISTORY_HISTORY_API}",
    "endpoint": "${API_HOST}" 
}
