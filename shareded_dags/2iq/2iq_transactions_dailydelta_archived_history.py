...
WORKFLOW_FILE = os.path.join(WORKFLOW_DIRECTORY, 
                		'2iq', '2iq_transactions_dailydelta_archived_history.yaml')
...
AIRFLOW_CONF_DICT = {
    "dag": {
        ...
        "priority_weight": 1,
        "dag_start_date": '2013-03-08',
        "dag_end_date": '2020-09-05',
        "dag_catchup": True

    },
    "crux_api_conf": "${2IQ_TRANSACTIONS_DAILYDELTA_ARCHIVED_HISTORY_API}",
    "endpoint": "${API_HOST}" 
}
